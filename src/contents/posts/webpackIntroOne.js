...
const postEn = {
  ...
  contents: [
    ...
    Some examples, just to give the idea:</p>`,
    `<ul>
    ...
    `<p>Now we can change it to suit our project structure</p>
    <ul>
    ...
    `<p>Webpack allows us to use the import/export features contained in <a href="https://developer.mozilla.org//en-US/docs/Web/JavaScript/Reference/Statements/import" target="_blank">ES2015 module import</a> without the needs of babel or other transpiler, webpack itself takes care of wrapping that code into something usable by all browsers. Let's try it out writing a couple functions and importing them in our index.js.</p>`,
    `<pre><code class="javascript post__code">
